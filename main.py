...
# Variables
posListX, posListY = [], []
xList = [item for item in range(0, 1300)] # for each of these value, we'll find the corresponding y value
prediction = False
...
while True:
    ...
    if posListX:
        ...
        if len(posListX) < 10:
            print (posListX)
            # Prediction
            # X values from 330 to 430; Y is 590
            a = A
            b = B
            c = C - 590
